<%-- 
    ...
    Created on : 8 may. 2022, 23:14:26
    Author     : Gustavo
--%>
...
<html>
    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <form class="reg-form" action="OperacionControlador?accion=verificarConsultaEstadoCuenta" method="POST" autocomplete="off">
                ...
                <button id="verificarConsultaEstadoCuenta" name="verificarConsultaEstadoCuenta" type="submit">Consultar</button>
