<%-- 
    Document   : consultaSaldoActualDolares
    Created on : 8 may. 2022, 22:45:46
    Author     : Gustavo
--%>
...
<html>
    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <h2>Solicitar saldo actual en dólares</h2>

            <form class="reg-form" action="OperacionControlador?accion=verificarConsultaSaldoActualDolares" method="POST" autocomplete="off">
                ...
                <button id="verificarConsultaSaldoActualDolares" name="verificarConsultaSaldoActualDolares" type="submit">Consultar</button>
